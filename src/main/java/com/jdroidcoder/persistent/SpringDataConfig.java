package com.jdroidcoder.persistent;
 ...
 */
@Configuration
@EnableJpaRepositories("com.jdroidcoder.persistent.repository")
public class SpringDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManager.setPackagesToScan(UserEntity.class.getPackage().getName());
